CREATE TABLE IF NOT EXISTS `tb_company_cfg` (
    ...
    UNIQUE INDEX `uk_third_company_id`(`third_company_id`) USING BTREE  COMMENT 'third_company_id唯一索引',
    UNIQUE INDEX `uk_company_id`(`company_id`) USING BTREE  COMMENT 'company_id唯一索引'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC  COMMENT '租户关系表';

CREATE TABLE IF NOT EXISTS `tb_las_user` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    ...
    `employment_status` varchar(60) DEFAULT 'notactive' COMMENT '就职状态[active, notactive, disabled]',
    `employment_type` varchar(60) DEFAULT NULL COMMENT '就职类型[permanent, intern]',
    `phone` varchar(60) DEFAULT NULL COMMENT '手机号',
    `telephone` varchar(60) DEFAULT NULL COMMENT '座机号',
    `source` varchar(20) DEFAULT 'sync' COMMENT '来源, buildin/sync',
    `custom_fields` varchar(5000) NULL COMMENT '自定义字段，json数组',
    `ctime` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `mtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE COMMENT '主键索引',
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC  COMMENT '三方用户表';

CREATE TABLE IF NOT EXISTS `tb_las_department` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT '三方部门表';

CREATE TABLE IF NOT EXISTS `tb_las_department_user` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `task_id` varchar(20) NOT NULL COMMENT '任务id',
    `third_company_id` varchar(20) NOT NULL COMMENT '租户id',
    ...
    PRIMARY KEY (`id`) USING BTREE COMMENT '主键索引',
    UNIQUE (`uid`, `did`, `task_id`, `third_company_id`, `platform_id`) COMMENT '唯一索引',
    INDEX `idx_did`(`did`, `task_id`) USING BTREE COMMENT '部门id索引',
    INDEX `idx_uid`(`uid`, `task_id`) USING BTREE COMMENT 'uid索引'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT '三方部门用户关系表';

CREATE TABLE IF NOT EXISTS `tb_las_user_increment` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `third_company_id` varchar(20) NOT NULL COMMENT '租户id',
    `platform_id` varchar(60) NOT NULL COMMENT '平台id, 用来区分多种数据源，platform_id + uid 唯一',
    `uid` varchar(255) NOT NULL COMMENT '用户id',
    ...
    `operator` varchar(20) DEFAULT '系统' COMMENT 'operator',
    `sync_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '增量数据变动时间',
    `ctime` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `mtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE COMMENT '主键索引',
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC  COMMENT '三方用户增量表';

CREATE TABLE IF NOT EXISTS `tb_las_department_increment` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `did` varchar(255) NOT NULL COMMENT '部门id',
    `third_company_id` varchar(20) NOT NULL COMMENT '租户id',
    `platform_id` varchar(60) NOT NULL COMMENT '平台id, 用来区分多种数据源，platform_id + did 唯一, 根部门例外',
...
CREATE TABLE IF NOT EXISTS `tb_las_department_user_increment` (
    `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `third_company_id` varchar(20) NOT NULL COMMENT '租户id',
    `platform_id` varchar(60) NOT NULL COMMENT '平台id, 用来区分多种数据源，platform_id + id 唯一',
    `uid` varchar(255) NOT NULL COMMENT '用户id',
