...
import { WPS4Params } from './WPS4Request'
import * as qs from 'querystring'

export class WPS4Context {
  host: string
  appId: string
  appKey: string
  ...
  stringify(params:WPS4Params) {
    params = this.removeUndefinedOrNullParams(params)
    return JSON.stringify(params)
  }

  private removeUndefinedOrNullParams(params:WPS4Params) {
    const values:WPS4Params = {}
