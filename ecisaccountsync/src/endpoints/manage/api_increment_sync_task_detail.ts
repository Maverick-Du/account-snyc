...
root.get('/api/manage/incrementsync/task/detail', async (ctx: Context) => {
  try {
    ...
    const detailData = await admin.getIncrementSyncDetail(Number(id), type as IncrementSyncType, companyId)
